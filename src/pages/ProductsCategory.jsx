    ...
    <div>
      <section className="py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mb-10  flex items-center justify-center font-semibold text-primary text-4xl">
            sugarcane based
          </h2>
          ...
          <div>
            <h2 className="mb-10 mt-10 flex items-center justify-center font-semibold text-primary text-4xl">
              plant based
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 ms:grid-cols-3 xl:grid-cols-4 gap-8 mt-10">
              <span className="relative bg-cover group rounded-3xl bg-center overflow-hidden mx-auto  xl:mx-auto cursor-pointer">
                <img
                  src="https://pagedone.io/asset/uploads/1700731972.png"
                  alt="Jacket image"
